...
import { searchProperty, toggleLoginModal, getAllAdverts } from '../../store/actions/Auth';
...
const PropertyDetails = ({ propertyId, propertyMarket, searchProperty, myProperty, propertyType, history, blogsData, onCardClick, isSearched, localData, modalLoader }) => {
  ...
  useEffect(() => {
    ...
    let remainingCost = parseInt(myProperty?.listPrice) - parseInt(myProperty?.listPrice) * 0.2;
    let interestPerYear = remainingCost * 0.02875;
    let principleInterest = interestPerYear * 30;
    ...
    let estimatedMonthlyCost = (remainingCost + principleInterest + perYearInsurance * 30 + yearTaxRate * 30) / 360;
    ...
    if (myProperty) {
      ...
      axios
        .get(apiUrl + 'ws/listings/search?market=gsmls&extended=true&listingtype=' + myProperty.listingType + '&details=true&listingDate=>6/1/2015&zip=' + myProperty.xf_postalcode, config)
        .then((res) => {
      ...
      {!modalLoader && myProperty && (
        <section className='detail-content'>
            ...
            <div className='detail-intro'>
                  ...
                  <div className='d-flex align-items-center'>
                    {myProperty.listPrice && (
                      <span className='cTBvcC'>
                        <span>
                          <span>${dollarUSLocale.format(myProperty.listPrice)}</span>
                        </span>
                      </span>
                    )}
                    ...
                    <div className='ds-bed-bath-living-area-header'>
                      <span className='ds-bed-bath-living-area-container'>
                        ...
                        <span className='ds-bed-bath-living-area'>
                          {myProperty.size ? (
                            <span>{myProperty.size && myProperty.size + ' sqft'}</span>
                          ) : (
                            <>
                              {' '}
                              <span>--</span>
              ...
              <div className='d-flex'>
                  ...
                  <div className='hweBDL ds-price-change-address-row'>
                    <div>
                      <h1 className='efSAZl'>
                        ...
                        <span>
                          &nbsp; {myProperty.address.city && myProperty.address.city}, {myProperty.address.state && myProperty.address.state} {myProperty.address.zip && myProperty.address.zip}
                        </span>
                      </h1>
                    </div>
                  </div>
                    ...
                    <p className='hHpaKQ'>
                      ...
                      <span className='bDWFjp'>
                        <span>
                          ...
                          :&nbsp;
                          <span className='einFCw'>${dollarUSLocale.format(myProperty.listPrice)}</span>
                        </span>
                      </span>
                    </p>
                  </div>
                ...
                <div className='col-4 d-flex flex-column justify-content-center align-items-center'>
                  ...
                  <div>
                    {' '}
                    <img src='https://i.ibb.co/hYHQmbD/calendar-512.webp' style={{ width: '64px' }} />
                  </div>
          ...
          <div className='leYhyN position-relative'>
            ...
            <div className='yASsG'>
              <nav aria-label='page' className='bMkZsT scrollNav position-relative' id='scrollNav'>
                <ul className='hJXnIl'>
                  <li className='eVYrJu' onClick={() => setActiveMenu('overview')}>
                    <a href='#overview' className={`bhJxVt ${activeMenuhandler('overview')}`}>
                      Overview
                    </a>
                  </li>
                  <li className='eVYrJu' onClick={() => setActiveMenu('facts')}>
                    <a href='#facts' className={`bhJxVt ${activeMenuhandler('facts')}`}>
                      Facts and features
                    </a>
                  </li>
                  ...
                  {relatedResult && (
                    <li className='eVYrJu' onClick={() => setActiveMenu('similar')}>
                      <a href='#similar' className={`bhJxVt ${activeMenuhandler('similar')}`}>
                        Similar homes
                      </a>
                    </li>
                  )}
          ...
          <div className='scroll-contant position-relative' id='modalScrollArea'>
            <div className='px-3'>
              <div className='ibZOdk'>{myProperty && <MapProperty propertiesList={[myProperty]} coordinates={myProperty && myProperty['coordinates']} />}</div>
                ...
                <div className='kAvzkP'>
                  ...
                  <div className='wVdMu'>
                    <div className='kYVsju'>
                      ...
                      <ul className='gsEezU'>
                        <li>
                          <span className='foiYRz'>Bedrooms: {myProperty.beds}</span>
                        </li>
                        <li>
                          <span className='foiYRz'>Bathrooms: {myProperty && myProperty.baths.total}</span>
                        </li>
                        <li>
                          <span className='foiYRz'>Full bathrooms: {myProperty && myProperty.baths.full}</span>
                        </li>
                      </ul>
                    </div>
                    <div className='kYVsju'>
                      ...
                      <ul className='gsEezU'>
                        <li>
                          <span className='foiYRz'>Basement: {myProperty && myProperty.xf_basement}</span>
                        </li>
                      </ul>
                    </div>
                    <div className='kYVsju'>
                    ...
                    <div className='kYVsju'>
                      ...
                      <ul className='gsEezU'>
                        ...
                        <li>
                          <span className='foiYRz'>Total interior livable area: sqft</span>
                        </li>
                        <li>
                          <span className='foiYRz'>Total number of fireplaces: {myProperty.xf_fireplaces}</span>
                        </li>
                        <li>
                ...
                <div className='kAvzkP'>
                  ...
                  <div className='wVdMu'>
                    <div className='kYVsju'>
                      ...
                      <ul className='gsEezU'>
                        <li>
                          <span className='foiYRz'>Total spaces: {myProperty.xf_garage}</span>
                        </li>
                        <li>
                    ...
                    <div className='kYVsju'>
                      ...
                      <ul className='gsEezU'>
                        <li>
                          <span className='foiYRz'>Accessibility features: </span>
                        </li>
                      </ul>
                    </div>
                    <div className='kYVsju'>
                      ...
                      <ul className='gsEezU'>
                        ...
                        <li>
                          <span className='foiYRz'>Patio and porch details: </span>
                        </li>
                      </ul>
                    </div>
                    <div className='kYVsju'>
                      ...
                      <ul className='gsEezU'>
                        <li>
                          <span className='foiYRz'>Lot size: {myProperty.lotSize && myProperty.lotSize.sqft} sqft</span>
                        </li>
                        <li>
                          <span className='foiYRz'>Lot size dimensions: 100 x 200</span>
                        </li>
                      </ul>
                    </div>
                    <div className='kYVsju'>
                      ...
                      <ul className='gsEezU'>
                        <li>
                          <span className='foiYRz'>Parcel number: 3000224000000007</span>
                        </li>
                        <li>
                          <span className='foiYRz'>Zoning description: Planned Residential,Residential,Single Family</span>
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <div className='kAvzkP'>
                  ...
                  <div className='wVdMu'>
                    <div className='kYVsju'>
                      ...
                      <ul className='gsEezU'>
                        <li>
                          <span className='foiYRz'>Home type: {myProperty.xf_subproptype}</span>
                        </li>
                        <li>
                          <span className='foiYRz'>
                            Architectural style:
                    ...
                    <div className='kYVsju'>
                      ...
                      <ul className='gsEezU'>
                        <li>
                          <span className='foiYRz'>
                            New construction:
                            {myProperty.newConstruction ? <span>Yes</span> : <span>No</span>}
                          </span>
                        </li>
                        <li>
                          <span className='foiYRz'>Year built: {myProperty.xf_yearbuilt}</span>
                        </li>
                      </ul>
                    </div>
                    <div className='kYVsju'>
                      ...
                      <ul className='gsEezU'>
                        <li>
                          <span className='foiYRz'>Builder model: Custom Normandy</span>
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <div className='kAvzkP'>
                  ...
                  <div className='wVdMu'>
                    <div className='kYVsju'>
                      ...
                      <ul className='gsEezU'>
                        <li>
                          <span className='foiYRz'>Sewer information: Public Sewer</span>
                        </li>
                      </ul>
                    </div>
                  </div>
                ...
                <div className='kAvzkP'>
                  ...
                  <div className='wVdMu'>
                    <div className='kYVsju'>
                      ...
                      <ul className='gsEezU'>
                        <li>
                          <span className='foiYRz'>Security features: Security System</span>
                        </li>
                      </ul>
                    </div>
                    <div className='kYVsju'>
                      ...
                      <ul className='gsEezU'>
                        <li>
                          <span className='foiYRz'>Community features: Association, Playground, Pool, Swimming, Tennis Court(s)</span>
                        </li>
                      </ul>
                    </div>
                    <div className='kYVsju'>
            ...
            <div className='dHtGQa' id='cost'>
              ...
              <div className='ePSpFA'>
                ...
                <h5 className='dTAnOx'>${interestvalues?.estimatedMonthlyCost?.toFixed(2)}</h5>
              </div>
              <div className='fgVRFP'>
                <div className='bnePEP'>
                  <div className='iMXoIt'>
                    <div className='cwZLoX' onClick={() => setShowPrincipal(!showPrincipal)}>
                      <div className='gqqTSu'>
                        <div className='jLwdhz'>
                          <span className='iuVuVk'>Principal&amp; interest</span>
                          <span className='cNBYuL'>${interestvalues?.principleInterestPerMonth?.toFixed(2)}/mo</span>
                        </div>
                        {/* switch icon */}
                        <div className='dropdownIcon'>{showPrincipal ? <i class='fa fa-angle-up'></i> : <i class='fa fa-angle-down'></i>}</div>
                        {/* switch icon */}
                      </div>
                    </div>
                  </div>
                    ...
                    <div className='calculatorDetailDiv'>
                      ...
                      <div className='mb-4'>
                        ...
                        <div className='position-relative inputWithLogo leftInput'>
                          <input type='number' className='w-100 ' min='10000' defaultValue={interestvalues?.homePrice} />
                          <span>$</span>
                        </div>
                      </div>
                      {/* Home Price */}
                      ...
                      <div className='mb-4 d-flex align-items-center'>
                        <div className='col-7 pl-0'>
                          ...
                          <div className='position-relative leftInput'>
                            <input type='number' className='w-100 leftInput' defaultValue={interestvalues?.downPayment} />
                            <span>$</span>
                          </div>
                        </div>
                        <div className='col-5 pl-0 pr-0'>
                          ...
                          <div className='position-relative rightInput'>
                            <input type='number' className='w-100 leftInput' defaultValue={interestvalues?.downPaymentPercentAge} />
                            <span>%</span>
                          </div>
                        </div>
                      </div>
                      ...
                      <div className='mb-4 d-flex align-items-center'>
                        ...
                        <div className='col-5 pl-0 pr-0'>
                          ...
                          <div className='position-relative rightInput'>
                            <input type='number' className='w-100 leftInput' defaultValue={interestvalues?.interestRate} />
                            <span>%</span>
                          </div>
                        </div>
                      </div>
                ...
                <div className='bnePEP'>
                  <div className='sc-pscky iMXoIt'>
                    <div className='sc-pjHjD cwZLoX' onClick={() => setShowMortage(!showMortage)}>
                      <div className='gqqTSu'>
                        <div className='jLwdhz'>
                        ...
                        {/* switch icon */}
                        <div className='dropdownIcon'>{showMortage ? <i class='fa fa-angle-up'></i> : <i class='fa fa-angle-down'></i>}</div>
                        {/* switch icon */}
                      </div>
                    </div>
                    {showMortage && (
                      <div className='calculatorDetailDiv'>
                        <div className='d-flex align-items-center'>
                          <input type='checkbox' />
                          <label className='mb-0 ml-2'>Include mortgage insurance</label>
                        </div>
                        <span className='minorDetail'>Mortgage insurance is usually required for down payments below 20%.</span>
                      </div>
                    )}
                  </div>
                </div>
                <div className='bnePEP'>
                  <div className='sc-pscky iMXoIt'>
                    <div className='sc-pjHjD cwZLoX' onClick={() => setShowtax(!showTax)}>
                      <div className='gqqTSu'>
                        <div className='jLwdhz'>
                          <span className='iuVuVk'>Property taxes</span>
                          <span className='cNBYuL'>${taxRate?.monthTaxRate?.toFixed(2)}/mo</span>
                        </div>
                        {/* switch icon */}
                        <div className='dropdownIcon'>{showTax ? <i class='fa fa-angle-up'></i> : <i class='fa fa-angle-down'></i>}</div>
                        {/* switch icon */}
                      </div>
                    </div>
                    {showTax && (
                      <div className='calculatorDetailDiv'>
                        <span className='minorDetail'>This estimate is based on the home value and an estimated local tax rate. Actual rate may vary.</span>
                        <div className='d-flex align-items-end mt-4'>
                          ...
                          <div className='col-5'>
                            ...
                            <div className='position-relative rightInput'>
                              <input type='number' className='w-100 leftInput' defaultValue={taxRate?.percentage} />
                              <span>%</span>
                            </div>
                          </div>
                          <div className='col-4'>
                            <p className='mb-0'>= ${taxRate?.yearTaxRate?.toFixed(2)} /year</p>
                          </div>
                        </div>
                      </div>
                    )}
                ...
                <div className='bnePEP'>
                  <div className='sc-pscky iMXoIt'>
                    <div className='sc-pjHjD cwZLoX'>
                      <div className='gqqTSu' onClick={() => setShowInsurance(!showInsurance)}>
                        <div className='jLwdhz'>
                          <span className='iuVuVk'>Home insurance</span>
                          <span className='cNBYuL'>${homeInsurance?.perMonthInsurance?.toFixed(2)}/mo</span>
                        </div>
                        {/* switch icon */}
                        <div className='dropdownIcon'>{showInsurance ? <i class='fa fa-angle-up'></i> : <i class='fa fa-angle-down'></i>}</div>
                        {/* switch icon */}
                      </div>
                      {showInsurance && (
                        <div className='calculatorDetailDiv'>
                          <div>
                            <div className='position-relative rightInput'>
                              <input type='number' defaultValue={homeInsurance?.perYearInsurance?.toFixed(2)} className='w-100 leftInput' style={{ paddingLeft: '30px' }} />
                              <span>/ year</span>
                              <span style={{ left: '10px', right: 'unset' }}>$</span>
                            </div>
                            <span className='minorDetail'>Some properties require monthly HOA dues to cover common amenities or services.</span>
                          </div>
                        </div>
                      )}
                    </div>
              ...
              <div className='kbPcQZ'>
                <span className='eUizBk'>All calculations are estimates and provided for informational purposes only. Actual amounts may vary.</span>
              </div>
            </div>
            {myProperty.schools && (
              <div className='dHtGQa' id='schools'>
                ...
                <div className='eUOzkf'>
                  ...
                  <div className='gtLCRl'>
                    {myProperty.schools.elementary && <div>Elementary: {myProperty.schools.elementary}</div>}
                    {myProperty.schools.middle && <div>Middle: {myProperty.schools.middle}</div>}
                    {myProperty.schools.high && <div>High: {myProperty.schools.high}</div>}
                  </div>
                  <p className='fhpxsu'>This data may not be complete. We recommend contacting the local school district to confirm school assignments for this home.</p>
                </div>
              </div>
            )}
                  ...
                  <Carousel responsive={responsive}>
                    {relatedResult &&
                      relatedResult.map((singleRelated, index) => {
                        return (
                          <div className='mx-1' key={index} style={{ paddingTop: '20px' }}>
                            <PropertyCard propertyValues={singleRelated} history={history} onCardClick={cardClick} />
                          </div>
                        );
                      })}
                  </Carousel>
            ...
            {provider && (
              <div className='home-details-listing-provided-by'>
                <div className='bUREIR'>
                  ...
                  <b>Copyrights:</b>
                  <p className='bDTsLB'>{provider.lexicon.en_US.copyright.replace('&copy; {current_date_year}', '2021')}</p>
                  <b>Disclaimer:</b>
