        ...
        {myProperty ? (
          <div className="detail-intro">
            ...
            <div className="hweBDL ds-price-change-address-row">
              <div>
                <h1 className="efSAZl">
                  {
                    <span>
                      {myProperty.address.street && myProperty.address.street},{" "}
                    </span>
                  }
                  <span>
            ...
            <div
              ...
              style={{ visibility: "visible", height: "26px", opacity: 1 }}
            >
              <p className="hHpaKQ">
            ...
            >
              <ul className="hJXnIl">
                ...
                <li className="eVYrJu" onClick={() => setActiveMenu("rent")}>
                  <a
                    href="#rental"
                    className={`bhJxVt ${activeMenuhandler("rent")}`}
                  >
                    Rental value
                  </a>
                </li>
                ...
                <div className="wVdMu">
                  <div className="kYVsju">
                    ...
                    <ul className="gsEezU">
                      ...
                      <li>
                        <span className="foiYRz">
                          Full bathrooms: {myProperty && myProperty.baths.full}
                        </span>
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="kYVsju">
                    ...
                    <ul className="gsEezU">
                      ...
                      <li>
                        <span className="foiYRz">
                          Total number of fireplaces: {myProperty.xf_fireplaces}
                        </span>
                      </li>
                      <li>
                        ...
                        <div className="blogBody">
                          ...
                          <p>
                            {blog.postcontent.length > 150
                              ? blog.postcontent.substring(0, 150).concat("...")
            ...
            <div className="home-details-listing-provided-by">
              <div className="bUREIR">
                <div className="inlRtt">
                  <img
                    alt=""
                    src={provider.assets.logo.url}
                  />
                </div>
                <b>Copyrights:</b>
                <p className="bDTsLB">
                {provider.lexicon.en_US.copyright.replace("&copy; {current_date_year}",'2021')}
                </p>
                <b>Disclaimer:</b>
                <p className="bDTsLB">
